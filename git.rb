...
element = driver.find_element(:xpath, "//*[@id='js-repo-pjax-container']/div[2]/div[1]/div[5]/div[2]/form/button").click
...
element = driver.find_element(:xpath, "//*[@id='submit-file']").click
